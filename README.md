...
- **Xorg, Vim, Emacs, Nano, Bash Shell, Zsh, Fish, Firewall, SSH, Tmux, Picom, Rofi, Polybar, i3wm, JWM, Urxvt, vscode**
...
- For *Linux*
  - [qgit](https://github.com/tibirna/qgit) Qt application for viewing GIT trees. *Debian/Ubuntu Repositories*
  - [gitg](https://wiki.gnome.org/Apps/Gitg/) git repository viewer. *Debian/Ubuntu Repositories*
  - [git-cola](https://packages.debian.org/search?keywords=git-cola&searchon=names&suite=stable&section=all) highly caffeinated git GUI. *Debian/Ubuntu Repositories*
  - [git-gui](https://packages.debian.org/search?keywords=git-gui&searchon=names&suite=stable&section=all), [gitk](https://packages.debian.org/search?keywords=gitk&searchon=names&suite=stable&section=all) fast, scalable, distributed revision control system (GUI). *Debian/Ubuntu Repositories*
...
- **Desktop Environment & Window Manager**
  - **i3wm** : [Site](https://i3wm.org/) / [Github i3](https://github.com/i3/i3)
  - **dwm** : [Github](https://dwm.suckless.org/)
  - **awesomewm** : [Site](https://awesomewm.org/) / [Github](https://github.com/awesomeWM/awesome)
  - **jwm** : [Site](https://joewing.net/projects/jwm/) / [Github JWM](https://github.com/joewing/jwm)
